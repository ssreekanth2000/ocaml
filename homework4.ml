...
let tm_q2_ab3 : string tm = dummyTM


let tm_q2_not : string tm = dummyTM


let tm_q2_and : string tm = dummyTM


let tm_q2_plus1 : string tm = dummyTM
...
let tm_q3_duplicate : string tm = dummyTM


let tm_q3_add : string tm = dummyTM
